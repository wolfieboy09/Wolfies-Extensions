(function (Scratch) {
    ...
    // internal varables
    var GAME_CLEAN_NAMES = ['Quake', 'Walls', 'Paintball', 'Blitz Survival Games', 'TNT Games', 'VampireZ', 'Mega Walls', 'Arcade', 'Arena', 'UHC Champions', 'Cops and Crims', 'Warlords', 'Smash Heroes', 'Turbo Kart Racers', 'Housing', 'SkyWars', 'Crazy Walls', 'Speed UHC', 'SkyClash', 'Classic Games', 'Prototype', 'Bed Wars', 'Murder Mystery', 'Build Battle', 'Duels', 'SkyBlock', 'Pit', 'Replay', 'SMP', 'Wool Wars']
    ...
    class Hypix {
      ...
      getGAMEINFOMATION({ GAME }) {
        return fetch('https://api.hypixel.net/v2/resources/games', {
          method: 'GET',
          headers: {
